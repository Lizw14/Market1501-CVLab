...
class Config:
    def __init__(self):
        self.use_gpu = 1
        self.gpuID = 1
        self.caffemodel = '/home/lizhuowan/Market1501/Res50_concat/regression/1/model/Res50_1_iter_65000.caffemodel'
        self.deployFile = '/home/lizhuowan/Market1501/Res50_concat/regression/Res50_pos30_deploy.prototxt'
        self.description_short = 'res50_pos30_regression'
        self.width = 224
        self.height = 224
        self.padValue = 127
        self.npoints = 15
        ...
        self.meanfile = '/home/lizhuowan/Market1501/lmdb/lmdb_12936/Image_lmdb_12936.binaryproto'
        self.resultdir = '/home/lizhuowan/Market1501/Res50_concat/regression/1/test/'
        # npoints = 17
...
if __name__ == '__main__':
    ...
    # test a folder
    imageDir = '/home/lizhuowan/Market1501/Market-1501-v15.09.15/bounding_box_test/'
    resultDir = param.resultdir
    textFile = open('/home/lizhuowan/Market1501/Anno_result/test_100.txt', 'r')
...
#    for i in xrange(10):
        ...
        save_image = resultDir + "%d" % i + "_res50.jpg"
        ...
        #rectangle = Rect(0, 0, image.shape[1], image.shape[0])
        #print image.shape[1],image.shape[0]
        #save_image = resultDir + "%d" % i + "_.jpg"
        #prediction = applymodel(net, image, param, rectangle)
        #if param.npoints == 14:
        #    draw_joints(test_image, prediction, save_image)
        #if param.npoints == 13:
